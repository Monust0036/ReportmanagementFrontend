...
class LeaveApplicationHRTable extends Component {
  ...
  loadLeaveApplicationHRData = () => {
    axios
      .get(process.env.REACT_APP_API_URL+ "/api/visual-inspection-report-hr/", {
        headers: {
  ...
  onLeaveApplicationHRDelete = (e1, e2) => {
    ...
    if (window.confirm("Are you sure to delete this record? ") == true) {
      axios
        .delete(
          process.env.REACT_APP_API_URL+ "/api/visual-inspection-report-hr/" + e1 + "/" + e2, {
          headers: {
            authorization: localStorage.getItem("token") || ""
          }
        }
  ...
  render() {
    return (
      <div id="table-outer-div-scroll">
        <h2 id="role-title">El inspection Reports</h2>
