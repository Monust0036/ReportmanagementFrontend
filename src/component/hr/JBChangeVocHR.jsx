...
import LeaveApplicationHRTable from "./JBChangeVocHRTable.jsx";
// import LeaveApplicationHRForm from "./LeaveApplicationHRForm.jsx";
import LeaveApplicationHRFormEdit from "./JBChangeVocHRFormEdit.jsx";
class LeaveApplicationHR extends Component {
    ...
    handleLeaveApplicationHRSubmit = event => {
      ...
      axios
        .post(process.env.REACT_APP_API_URL+ "/api/jbChange-Voc-hr/" + this.props.data["_id"], body, {
          headers: {
    ...
    handleLeaveApplicationHREditUpdate = (info, newInfo) => {
      ...
      axios
        .put(
          process.env.REACT_APP_API_URL+ "/api/jbChange-Voc-hr/" + info["_id"],
          body, {
          headers: {
            authorization: localStorage.getItem("token") || ""
          }
