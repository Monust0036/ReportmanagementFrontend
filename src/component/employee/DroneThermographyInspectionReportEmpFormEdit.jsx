...
class LeaveApplicationEmpForm extends Component {
  state = {
      ...
      // inspection result
        ...
        NoofFlightsDoneData:this.props.editData["NoofFlightsDone"],
        PilotNameData:this.props.editData["PilotName"],
        CoPilotNameData:this.props.editData["CoPilotName"],
      // observation form 
  ...
  onNoofFlightsDoneDataChange(e) {
          this.setState({ NoofFlightsDoneData: e.target.value });
  }
  onPilotNameDataChange(e) {
          this.setState({ PilotNameData: e.target.value });
  }
  onCoPilotNameDataChange(e) {
          this.setState({ CoPilotNameData: e.target.value });
  }
      // observation form 
  ...
  render() {
    return (
      <div>
        <h2 id="role-form-title">Drone Thermography Detail</h2>
  ...
  <Form.Group as={Row}>
     ...
     <Col sm={10}  className="form-input">
      <Form.Control type="Text" placeholder="NoofFlightsDoneData" required
       value={this.state.NoofFlightsDoneData}
       onChange={value => this.onNoofFlightsDoneDataChange(value)}/>
    </Col>
  </Form.Group>
  <Form.Group as={Row}>
     <Form.Label column sm={2}>
     ...
     <Col sm={10}  className="form-input">
      <Form.Control type="Text" placeholder="No Of Repairable" required
       value={this.state.PilotNameData}
       onChange={value => this.onPilotNameDataChange(value)}/>
    </Col>
  </Form.Group>
  <Form.Group as={Row}>
     <Form.Label column sm={2}>
     ...
     <Col sm={10}  className="form-input">
      <Form.Control type="Text" placeholder="CoPilotNameData" required
       value={this.state.CoPilotNameData}
       onChange={value => this.onCoPilotNameDataChange(value)}/>
    </Col>
  </Form.Group>
  <Form.Group as={Row}>
     <Form.Label column sm={2}>
