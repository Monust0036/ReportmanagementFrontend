...
import LeaveApplicationEmpTable from "./PreDispatchInspectionTable.jsx";
import LeaveApplicationEmpForm from "./PreDispatchInspectionForm.jsx";
import LeaveApplicationEmpFormEdit from "./PreDispatchInspectionFormEdit.jsx";
class LeaveApplicationEmp extends Component {
  ...
  handleLeaveApplicationEmpSubmit = event => {
    ...
    axios
      .post(process.env.REACT_APP_API_URL+ "/api/pre-dispatch-inspection-emp/" + this.props.data["_id"], body, {
        headers: {
  ...
  handleLeaveApplicationEmpEditUpdate = (info, newInfo) => {
    ...
    axios
      .put(
        process.env.REACT_APP_API_URL+ "/api/pre-dispatch-inspection-emp/" + info["_id"],
        body, {
        headers: {
          authorization: localStorage.getItem("token") || ""
        }
