...
class LeaveApplicationEmpTable extends Component {
  ...
  loadLeaveApplicationEmpData = () => {
    axios
      .get(
        process.env.REACT_APP_API_URL+ "/api/add-expense-emp/" +
        this.props.data["_id"], {
        headers: {
      ...
      .then(response => {
        ...
        this.leaveApplicationEmpObj.addExpense.map(data => {
          let temp = {
            data,
  ...
  onLeaveApplicationEmpDelete = (e1, e2) => {
    ...
    if (window.confirm("Are you sure to delete this record? ") == true) {
      axios
        .delete(
          process.env.REACT_APP_API_URL+ "/api/add-expense-emp/" + e1 + "/" + e2, {
          headers: {
            authorization: localStorage.getItem("token") || ""
          }
        }
  ...
  render() {
    return (
      <div id="table-outer-div-scroll">
        <h2 id="role-title">Add/view Exepenses</h2>
