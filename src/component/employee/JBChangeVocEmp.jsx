...
import LeaveApplicationEmpTable from "./JBChangeVocEmpTable.jsx";
import LeaveApplicationEmpForm from "./JBChangeVocEmpForm.jsx";
import LeaveApplicationEmpFormEdit from "./JBChangeVocEmpFormEdit.jsx";
class LeaveApplicationEmp extends Component {
  ...
  handleLeaveApplicationEmpSubmit = event => {
    ...
    let body = {
      ...
      FileUpload:event.target[7].value,
