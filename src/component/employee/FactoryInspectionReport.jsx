...
import LeaveApplicationEmpTable from "./FactoryInspectionReportTable.jsx";
import LeaveApplicationEmpForm from "./FactoryInspectionReportForm.jsx";
import LeaveApplicationEmpFormEdit from "./FactoryInspectionReportFormEdit.jsx";
class LeaveApplicationEmp extends Component {
  ...
  handleLeaveApplicationEmpSubmit = event => {
    ...
    axios
      .post(process.env.REACT_APP_API_URL+ "/api/factory-inspection-emp/" + this.props.data["_id"], body, {
        headers: {
  ...
  handleLeaveApplicationEmpEditUpdate = (info, newInfo) => {
    ...
    axios
      .put(
        process.env.REACT_APP_API_URL+ "/api/factory-inspection-emp/" + info["_id"],
        body, {
        headers: {
          authorization: localStorage.getItem("token") || ""
        }
