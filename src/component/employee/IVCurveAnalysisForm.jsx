  ...
  render() {
    return (
      <div>
        ...
        <h2 id="role-form-title">IV Curve Analysis Report</h2>
...
//         <h2 id="role-form-title">IV Curve Analysis Reports</h2>
//  <div id="role-form-outer-div"><Form id="form" enctype="multipart/form-data" onSubmit={this.props.onLeaveApplicationEmpSubmit} >
...
//     </Col>
//   </Form.Group>
//   <h4 id="role-form-title" style={{textAlign:"center" }}>Inspection Details</h4>
//   <Form.Group as={Row}>
//      <Form.Label column sm={2}>
//      InspectionCompleted
//      </Form.Label>
