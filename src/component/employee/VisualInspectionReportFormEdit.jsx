...
class LeaveApplicationEmpForm extends Component {
  state = {
      ...
      // inspection result
        AcceptanceValueData:this.props.editData["AcceptanceValue"],
        NoOfOkData:this.props.editData["NoOfOk"],
        NoOfNotOkData:this.props.editData["NoOfNotOk"],
        NoOfRepairableData:this.props.editData["NoOfRepairable"],
  ...
  onTrackerDataChange(e) {
      ...
      // inspection result
  onAcceptanceValueDataChange(e) {
          this.setState({ AcceptanceValueData: e.target.value });
  }
  onNoOfOkDataChange(e) {
          this.setState({ NoOfOkData: e.target.value });
  }
  onNoOfNotOkDataChange(e) {
          this.setState({ NoOfNotOkData: e.target.value });
  }
  onNoOfRepairableDataChange(e) {
          this.setState({ NoOfRepairableData: e.target.value });
  }
  ...
  render() {
    return (
      <div>
        <h2 id="role-form-title"> Visual Inspection Report Detail</h2>
  ...
  <Form.Group as={Row}>
     ...
     <Col sm={10}  className="form-input">
      <Form.Control type="Text" placeholder="AcceptanceValueData" required
       value={this.state.AcceptanceValueData}
       onChange={value => this.onAcceptanceValueDataChange(value)}/>
    </Col>
  </Form.Group>
  <Form.Group as={Row}>
     <Form.Label column sm={2}>
     ...
     <Col sm={10}  className="form-input">
      <Form.Control type="Text" placeholder="NoOfOkData" required
       value={this.state.NoOfOkData}
       onChange={value => this.onNoOfOkDataChange(value)}/>
    </Col>
  </Form.Group>
  <Form.Group as={Row}>
     <Form.Label column sm={2}>
     ...
     <Col sm={10}  className="form-input">
      <Form.Control type="Text" placeholder="NoOfNotOkData" required
       value={this.state.NoOfNotOkData}
       onChange={value => this.onNoOfNotOkDataChange(value)}/>
    </Col>
  </Form.Group>
  <Form.Group as={Row}>
     <Form.Label column sm={2}>
     ...
     <Col sm={10}  className="form-input">
      <Form.Control type="Text" placeholder="No Of Repairable" required
       value={this.state.NoOfRepairableData}
       onChange={value => this.onNoOfRepairableDataChange(value)}/>
    </Col>
  </Form.Group>
  <Form.Group as={Row}>
     <Form.Label column sm={2}>
