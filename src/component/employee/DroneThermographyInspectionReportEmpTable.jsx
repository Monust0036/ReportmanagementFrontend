...
class LeaveApplicationEmpTable extends Component {
  state = {
    ...
    //   },
      ...
      {
        headerName: "NoofFlightsDone",
        field: "NoofFlightsDone",
        sortable: true,
        // width: 150,
        // filter: true ,
      },
      {
        headerName: "PilotName",
        field: "PilotName",
        sortable: true,
        // width: 150,
        // filter: true ,
  ...
  loadLeaveApplicationEmpData = () => {
    axios
      .get(
        process.env.REACT_APP_API_URL+ "/api/drone-thermography-inspection-emp/" +
        this.props.data["_id"], {
        headers: {
      ...
      .then(response => {
        ...
        this.leaveApplicationEmpObj.droneThermographyInspectionReport.map(data => {
          let temp = {
            ...
            NoofFlightsDone:data["NoofFlightsDone"],
  ...
  onLeaveApplicationEmpDelete = (e1, e2) => {
    ...
    if (window.confirm("Are you sure to delete this record? ") == true) {
      axios
        .delete(
          process.env.REACT_APP_API_URL+ "/api/drone-thermography-inspection-emp/" + e1 + "/" + e2, {
          headers: {
            authorization: localStorage.getItem("token") || ""
          }
        }
  ...
  render() {
    ...
    return (
      <div id="table-outer-div-scroll">
        <h2 id="role-title">Drone thermography Reports</h2>
        ...
        <MDBContainer fluid className="text-white">
              <MDBRow>
                ...
                <img src={JsrLogo} alt="" style={{width:"75%"}}/>
                  ...
                  <MDBCol md="4" style={{border:"1px solid black"}}>
                  <h3 style={{fontSize:"20px", fontWeight:"600",color:"#212529"}}>Drone Thermography Inspection Report</h3>
                  </MDBCol>
                <MDBCol md="4" style={{border:"1px solid black"}}>
          ...
          <MDBRow>
            ...
            <MDBRow>
              ...
              <MDBRow>
                  <h3 style={{fontSize:"18px", fontWeight:"600",color:"black"}}>Flight Details -</h3>
              </MDBRow>
            ...
            <MDBTable bordered responsive>
              ...
              <tr>
                ...
                <td style={{backgroundColor:"rgb(211 208 228 / 91%)"}}><p style={{fontWeight:"600", color:"brown"}}>Pilot Name</p></td>
                <td><p>{this.state.irReportData.PilotName}</p></td>
              </tr>
                <tr>
                  ...
                  <td style={{backgroundColor:"rgb(211 208 228 / 91%)"}}><p style={{fontWeight:"600", color:"brown"}}>Co PilotName</p></td>
                  <td><p>{this.state.irReportData.CoPilotName}</p></td>
                </tr>
                <tr>
                  <td style={{backgroundColor:"rgb(211 208 228 / 91%)"}}><p style={{fontWeight:"600", color:"brown"}}>No of Flights Done</p></td>
                  <td><p>{this.state.irReportData.NoofFlightsDone}</p></td>
                  <td><p></p></td>
                  <td></td>
                </tr>
              </MDBTableBody>
