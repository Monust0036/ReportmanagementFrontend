...
class LeaveApplicationEmpTable extends Component {
  ...
  loadLeaveApplicationEmpData = () => {
    axios
      .get(
        process.env.REACT_APP_API_URL+ "/api/manual-thermography-report-emp/" +
        this.props.data["_id"], {
        headers: {
      ...
      .then(response => {
        ...
        this.leaveApplicationEmpObj.manualThermographyReport.map(data => {
          let temp = {
            data,
  ...
  onLeaveApplicationEmpDelete = (e1, e2) => {
    ...
    if (window.confirm("Are you sure to delete this record? ") == true) {
      axios
        .delete(
          process.env.REACT_APP_API_URL+ "/api/manual-thermography-report-emp/" + e1 + "/" + e2, {
          headers: {
            authorization: localStorage.getItem("token") || ""
          }
        }
        ...
        <MDBContainer fluid className="text-white">
              <MDBRow>
                ...
                <img src={JsrLogo} alt="" style={{width:"75%"}}/>
                  ...
                  <MDBCol md="4" >
                  <h3 style={{fontSize:"22px", fontWeight:"600",color:"#212529"}}>Manual Thermography Report </h3>
                  </MDBCol>
                <MDBCol md="4" >
