...
import LeaveApplicationEmpTable from "./ManualThermographyReportEmpTable.jsx";
import LeaveApplicationEmpForm from "./ManualThermographyReportEmpForm.jsx";
import LeaveApplicationEmpFormEdit from "./ManualThermographyReportEmpFormEdit.jsx";
class LeaveApplicationEmp extends Component {
  ...
  handleLeaveApplicationEmpSubmit = event => {
    ...
    axios
      .post(process.env.REACT_APP_API_URL+ "api/manual-thermography-report-emp/" + this.props.data["_id"], body, {
        headers: {
  ...
  handleLeaveApplicationEmpEditUpdate = (info, newInfo) => {
    ...
    axios
      .put(
        process.env.REACT_APP_API_URL+ "api/manual-thermography-report-emp/" + info["_id"],
        body, {
        headers: {
          authorization: localStorage.getItem("token") || ""
        }
