...
class LeaveApplicationEmpForm extends Component {
  ...
  render() {
    return (
      <div>
        ...
        <h2 id="role-form-title">Drone Thermography Details</h2>
 ...
 <Form.Group as={Row}>
  ...
  <h4 id="role-form-title" style={{textAlign:"center" }}>Flight Details -</h4>
  <Form.Group as={Row}>
     <Form.Label column sm={2}>
     InspectionCompleted
     </Form.Label>
  ...
  <Form.Group as={Row}>
     ...
     <Col sm={10}  className="form-input">
      <Form.Control type="Text" placeholder=" NoofFlightsDone" required
      />
    </Col>
  </Form.Group>
  <Form.Group as={Row}>
     ...
     <Col sm={10}  className="form-input">
      <Form.Control type="Text" placeholder="PilotName" required
      />
    </Col>
  </Form.Group>
  <Form.Group as={Row}>
     ...
     <Col sm={10}  className="form-input">
      <Form.Control type="Text" placeholder="CoPilotName" required
      />
    </Col>
  </Form.Group>
