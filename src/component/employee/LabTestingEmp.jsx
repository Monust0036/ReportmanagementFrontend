...
import LeaveApplicationEmpTable from "./LabTestingTable.jsx";
import LeaveApplicationEmpForm from "./LabTestingForm.jsx";
import LeaveApplicationEmpFormEdit from "./LabTestingFormEdit.jsx";
class LeaveApplicationEmp extends Component {
  ...
  handleLeaveApplicationEmpSubmit = event => {
    ...
    axios
      .post(process.env.REACT_APP_API_URL+ "/api/lab-testing-emp/" + this.props.data["_id"], body, {
        headers: {
  ...
  handleLeaveApplicationEmpEditUpdate = (info, newInfo) => {
    ...
    axios
      .put(
        process.env.REACT_APP_API_URL+ "/api/lab-testing-emp/" + info["_id"],
        body, {
        headers: {
          authorization: localStorage.getItem("token") || ""
        }
